            ...
            <table class="table" id="example1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $no }}</td>
                        <td>
                            <img src="{{ url('storage') }}" alt="" class="rounded-circle"
                        ...
                        <td>
                            <form method="post" action="{{ url('user') }}" id="delete">
                                @csrf
                                @method('delete')
                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteData">
                                    <i data-feather='trash'></i></button>
                                <a href="javascript:void(0)" id="btn-edit-post" data-id=""
